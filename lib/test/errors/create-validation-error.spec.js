...
describe('#createValidationError', () => {
    describe('regular error', () => {
        it('has errors', () => {
            const error = (0, create_validation_error_1.createValidationError)(mongoose_validation_error_1.SAMPLE_VALIDATION_ERROR);
    ...
    describe('error for nested field', () => {
        it('2 errors, one for root field and one for an actual nested field', () => {
            const error = (0, create_validation_error_1.createValidationError)(mongoose_nested_validation_error_1.SAMPLE_NESTED_VALIDATION_ERROR);
            expect(Object.keys(error.propertyErrors).length).toEqual(2);
        });
